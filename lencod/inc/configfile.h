...
Mapping Map[] = {
    ...
    {"VUI_aspect_ratio_info_present_flag",     &configinput.VUI_aspect_ratio_info_present_flag,     0,   0.0,                       1,  0.0,              1.0              },
    {"VUI_aspect_ratio_idc",                   &configinput.VUI_aspect_ratio_idc,                   0,   0.0,                       1,  0.0,            255.0              },
    {"VUI_sar_width",                          &configinput.VUI_sar_width,                          0,   0.0,                       2,  0.0,              0.0              },
    {"VUI_sar_height",                         &configinput.VUI_sar_height,                         0,   0.0,                       2,  0.0,              0.0              },
    {"VUI_overscan_info_present_flag",         &configinput.VUI_overscan_info_present_flag,         0,   0.0,                       1,  0.0,              1.0              },
    {"VUI_overscan_appropriate_flag",          &configinput.VUI_overscan_appropriate_flag,          0,   0.0,                       1,  0.0,              1.0              },
    {"VUI_video_signal_type_present_flag",     &configinput.VUI_video_signal_type_present_flag,     0,   0.0,                       1,  0.0,              1.0              },
    {"VUI_video_format",                       &configinput.VUI_video_format,                       0,   5.0,                       1,  0.0,              7.0              },
    {"VUI_video_full_range_flag",              &configinput.VUI_video_full_range_flag,              0,   0.0,                       1,  0.0,              1.0              },
    {"VUI_colour_description_present_flag",    &configinput.VUI_colour_description_present_flag,    0,   0.0,                       1,  0.0,              1.0              },
    {"VUI_colour_primaries",                   &configinput.VUI_colour_primaries,                   0,   2.0,                       1,  0.0,            255.0              },
    {"VUI_transfer_characteristics",           &configinput.VUI_transfer_characteristics,           0,   2.0,                       1,  0.0,            255.0              },
    {"VUI_matrix_coefficients",                &configinput.VUI_matrix_coefficients,                0,   2.0,                       1,  0.0,            255.0              },
    {"VUI_chroma_location_info_present_flag",  &configinput.VUI_chroma_location_info_present_flag,  0,   0.0,                       1,  0.0,              1.0              },
    {"VUI_chroma_sample_loc_type_top_field",   &configinput.VUI_chroma_sample_loc_type_top_field,   0,   0.0,                       1,  0.0,              5.0              },
    {"VUI_chroma_sample_loc_type_bottom_field",&configinput.VUI_chroma_sample_loc_type_bottom_field,0,   0.0,                       1,  0.0,              5.0              },
    {"VUI_timing_info_present_flag",           &configinput.VUI_timing_info_present_flag,           0,   0.0,                       1,  0.0,              1.0              },
    {"VUI_num_units_in_tick",                  &configinput.VUI_num_units_in_tick,                  0,1000.0,                       2,  0.0,              0.0              },
    {"VUI_time_scale",                         &configinput.VUI_time_scale,                         0,60000.0,                      2,  0.0,              0.0              },
    {"VUI_fixed_frame_rate_flag",              &configinput.VUI_fixed_frame_rate_flag,              0,   0.0,                       1,  0.0,              1.0              },
    {"VUI_nal_hrd_parameters_present_flag",    &configinput.VUI_nal_hrd_parameters_present_flag,    0,   0.0,                       1,  0.0,              1.0              },
    {"VUI_nal_cpb_cnt_minus1",                 &configinput.VUI_nal_cpb_cnt_minus1,                 0,   0.0,                       1,  0.0,             31.0              },
    {"VUI_nal_bit_rate_scale",                 &configinput.VUI_nal_bit_rate_scale,                 0,   0.0,                       2,  0.0,              0.0              },
    {"VUI_nal_cpb_size_scale",                 &configinput.VUI_nal_cpb_size_scale,                 0,   0.0,                       2,  0.0,              0.0              },
    {"VUI_nal_bit_rate_value_minus1",          &configinput.VUI_nal_bit_rate_value_minus1,          0,   0.0,                       2,  0.0,              0.0              },
    {"VUI_nal_cpb_size_value_minus1",          &configinput.VUI_nal_cpb_size_value_minus1,          0,   0.0,                       2,  0.0,              0.0              },
    {"VUI_nal_vbr_cbr_flag",                   &configinput.VUI_nal_vbr_cbr_flag,                   0,   0.0,                       1,  0.0,              1.0              },
    {"VUI_nal_initial_cpb_removal_delay_length_minus1", &configinput.VUI_nal_initial_cpb_removal_delay_length_minus1,  0, 23.0,     2,  0.0,              0.0              },
    {"VUI_nal_cpb_removal_delay_length_minus1",&configinput.VUI_nal_cpb_removal_delay_length_minus1,0,  23.0,                       2,  0.0,              0.0              },
    {"VUI_nal_dpb_output_delay_length_minus1", &configinput.VUI_nal_dpb_output_delay_length_minus1, 0,  23.0,                       2,  0.0,              0.0              },
    {"VUI_nal_time_offset_length",             &configinput.VUI_nal_time_offset_length,             0,  24.0,                       2,  0.0,              0.0              },
    {"VUI_vcl_hrd_parameters_present_flag",    &configinput.VUI_vcl_hrd_parameters_present_flag,    0,   0.0,                       1,  0.0,              1.0              },
    {"VUI_vcl_cpb_cnt_minus1",                 &configinput.VUI_vcl_cpb_cnt_minus1,                 0,   0.0,                       1,  0.0,             31.0              },
    {"VUI_vcl_bit_rate_scale",                 &configinput.VUI_vcl_bit_rate_scale,                 0,   0.0,                       2,  0.0,              0.0              },
    {"VUI_vcl_cpb_size_scale",                 &configinput.VUI_vcl_cpb_size_scale,                 0,   0.0,                       2,  0.0,              0.0              },
    {"VUI_vcl_bit_rate_value_minus1",          &configinput.VUI_vcl_bit_rate_value_minus1,          0,   0.0,                       2,  0.0,              0.0              },
    {"VUI_vcl_cpb_size_value_minus1",          &configinput.VUI_vcl_cpb_size_value_minus1,          0,   0.0,                       2,  0.0,              0.0              },
    {"VUI_vcl_vbr_cbr_flag",                   &configinput.VUI_vcl_vbr_cbr_flag,                   0,   0.0,                       1,  0.0,              1.0              },
    {"VUI_vcl_initial_cpb_removal_delay_length_minus1", &configinput.VUI_vcl_initial_cpb_removal_delay_length_minus1,  0,  23.0,    2,  0.0,              0.0              },
    {"VUI_vcl_cpb_removal_delay_length_minus1",&configinput.VUI_vcl_cpb_removal_delay_length_minus1,0,  23.0,                       2,  0.0,              0.0              },
    {"VUI_vcl_dpb_output_delay_length_minus1", &configinput.VUI_vcl_dpb_output_delay_length_minus1, 0,  23.0,                       2,  0.0,              0.0              },
    {"VUI_vcl_time_offset_length",             &configinput.VUI_vcl_time_offset_length,             0,  24.0,                       2,  0.0,              0.0              },
    {"VUI_low_delay_hrd_flag",                 &configinput.VUI_low_delay_hrd_flag,                 0,   0.0,                       1,  0.0,              1.0              },
    {"VUI_pic_struct_present_flag",            &configinput.VUI_pic_struct_present_flag,            0,   0.0,                       1,  0.0,              1.0              },
    {"VUI_bitstream_restriction_flag",         &configinput.VUI_bitstream_restriction_flag,         0,   0.0,                       1,  0.0,              1.0              },
    {"VUI_motion_vectors_over_pic_boundaries_flag", &configinput.VUI_motion_vectors_over_pic_boundaries_flag,      0,   0.0,        1,  0.0,              1.0              },
    {"VUI_max_bytes_per_pic_denom",            &configinput.VUI_max_bytes_per_pic_denom,            0,   0.0,                       1,  0.0,             16.0              },
    {"VUI_max_bits_per_mb_denom",              &configinput.VUI_max_bits_per_mb_denom,              0,   0.0,                       1,  0.0,             16.0              },
    {"VUI_log2_max_mv_length_vertical",        &configinput.VUI_log2_max_mv_length_vertical,        0,  16.0,                       1,  0.0,             16.0              },
    {"VUI_log2_max_mv_length_horizontal",      &configinput.VUI_log2_max_mv_length_horizontal,      0,  16.0,                       1,  0.0,             16.0              },
    {"VUI_num_reorder_frames",                 &configinput.VUI_num_reorder_frames,                 0,  16.0,                       1,  0.0,             16.0              },
    {"VUI_max_dec_frame_buffering",            &configinput.VUI_max_dec_frame_buffering,            0,  16.0,                       1,  0.0,             16.0              },
